  ...
  const fetchTags = async () => {
    try {
      ...
      if (response && response.success) {
        ...
        setTotalTags(response.pagination?.total || 0);
        setStats(response.stats || { total: 0, active: 0, popular: 0, totalMentions: 0 });
      } else {
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 p-4">
          <p className="text-2xl font-bold text-gray-900 dark:text-gray-100">{stats.total || totalTags}</p>
        ...
        <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 p-4">
          <p className="text-2xl font-bold text-blue-600 dark:text-blue-400">{stats.totalMentions || 0}</p>
          <p className="text-sm text-gray-500 dark:text-gray-400">Total Mentions</p>
        </div>
        <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 p-4">
          <p className="text-2xl font-bold text-purple-600 dark:text-purple-400">{stats.popular || 0}</p>
                  ...
                  <div className="mt-4 space-y-4">
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        className="w-full px-4 py-2 bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition resize-y text-sm"
                      />
                      <p className="mt-1 text-xs text-gray-400">
              ...
              <div>
                ...
                >
                  <div className="flex items-center gap-2">
                    ...
                    <span className="font-semibold text-gray-900 dark:text-gray-100">SEO Settings</span>
                  </div>
