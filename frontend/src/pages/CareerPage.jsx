// src/pages/CareerPage.jsx - Complete UWorld-Style Career Page
...
import healthcarePattern from "../assets/healthcare-pattern.svg"; // Add pattern image
...
const CareerPage = () => {
  ...
  const sampleJobs = [
    {
      ...
      posted: "2 days ago",
      description:
        "Lead the development of innovative nursing education programs and curriculum. You'll shape the next generation of nursing professionals by creating evidence-based, engaging learning materials that align with international nursing standards.",
      responsibilities: [
    ...
    },
    {
      ...
      posted: "3 days ago",
      description:
        "Join our clinical education team to create immersive simulation experiences for nursing and healthcare students. You'll develop virtual clinical scenarios, manage simulation lab operations, and train educators on simulation best practices.",
      responsibilities: [
    ...
    },
    {
      ...
      posted: "5 days ago",
      description:
        "Create compelling, accurate healthcare education content for nursing and medical students. You'll write and edit educational materials, ensure medical accuracy, and help develop our comprehensive content library.",
      responsibilities: [
    ...
    },
    {
      ...
      posted: "1 week ago",
      description:
        "Join our team as a Clinical Instructor to guide and mentor nursing students in clinical settings. You'll provide hands-on instruction, evaluate student performance, and help bridge the gap between theory and practice.",
      responsibilities: [
    ...
    },
    {
      ...
      posted: "4 days ago",
      description:
        "Innovate healthcare education through technology. You'll develop and implement educational technology solutions, work with our development team, and ensure our e-learning platforms meet the needs of healthcare students.",
      responsibilities: [
    ...
    },
    {
      ...
      posted: "6 days ago",
      description:
        "Design and implement assessment strategies for healthcare education programs. You'll develop evaluation tools, analyze student outcomes, and ensure our assessment practices align with professional standards.",
      responsibilities: [
    ...
    },
    {
      ...
      posted: "1 week ago",
      description:
        "Lead nursing research initiatives and promote evidence-based practice across our educational programs. You'll coordinate research projects, mentor faculty, and integrate research findings into curriculum.",
      responsibilities: [
    ...
    },
    {
      ...
      posted: "3 days ago",
      description:
        "Support simulation-based education through technology management and technical expertise. You'll maintain simulation equipment, develop technical solutions, and support faculty and students in simulation activities.",
      responsibilities: [
  ...
  return (
    <div className="min-h-screen bg-white font-['Inter',sans-serif] overflow-x-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-gray-600 max-w-2xl mx-auto text-lg">
              We create innovative educational solutions that empower healthcare
              professionals to achieve excellence in their careers.
            </p>
          </motion.div>
      ...
      <section id="life-at-alveoly" className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {benefits.map((benefit, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
                className="bg-gray-50 rounded-xl p-6 shadow-sm hover:shadow-lg transition-all duration-300 text-center group"
              >
