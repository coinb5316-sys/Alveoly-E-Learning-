...
import financeBg from "../images/finance-bg.jpg";
  ...
  const features = [
    {
      ...
      description: "Master core financial concepts, theories, and principles used in the financial industry.",
    },
    {
      icon: FaVideo,
      title: "Expert Lectures",
      description: "Learn from industry experts through comprehensive video lectures and tutorials.",
    },
    {
      icon: FaClipboardCheck,
      title: "Practice Problems",
      description: "Practice with real-world financial scenarios and case studies.",
    },
    {
      icon: FaChartLine,
      title: "Investment Analysis",
      description: "Learn investment strategies, portfolio management, and risk assessment.",
    },
  ];

  const financeAreas = [
    { icon: FaUniversity, name: "Corporate Finance", color: "text-blue-500" },
    { icon: FaHandHoldingUsd, name: "Investment Banking", color: "text-red-500" },
    { icon: FaCoins, name: "Asset Management", color: "text-green-500" },
    { icon: FaChartBar, name: "Financial Planning", color: "text-purple-500" },
    { icon: FaPiggyBank, name: "Personal Finance", color: "text-indigo-500" },
    { icon: FaMoneyBillWave, name: "International Finance", color: "text-yellow-600" },
  ];
        ...
        <div className="relative z-10 h-full max-w-[1180px] mx-auto px-6 flex items-center">
          ...
          >
            <div className="flex items-center gap-3 mb-4">
              <FaMoneyBillWave className="text-[#f7c928] text-3xl" />
            ...
            <p className="mt-4 text-white/85 text-[15px] md:text-[16px] leading-6 max-w-[450px]">
              Comprehensive finance education and exam preparation resources
              designed to help you succeed in the financial industry.
            </p>
            <button
              onClick={() => navigate("/programs?category=finance")}
        ...
        <div className="max-w-[1180px] mx-auto px-6">
          <div className="text-center mb-12">
            <h2 className="text-[#555] font-normal text-[28px] md:text-[34px]">
              Why Choose Our Finance Program?
            </h2>
            <p className="mt-3 text-[14px] text-[#777] max-w-[600px] mx-auto">
              Everything you need to excel in finance and build a successful career
            </p>
          </div>
        ...
        <div className="max-w-[1180px] mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="mt-3 text-[14px] text-[#777]">
              Comprehensive coverage across all major finance disciplines
            </p>
          </div>
      ...
      <section className="py-16 md:py-20 bg-[#1687df]">
        <div className="max-w-[900px] mx-auto px-6 text-center">
          ...
          <p className="mt-4 text-white/85 text-[15px] max-w-[600px] mx-auto">
            Join thousands of finance students who have successfully prepared
            with Alveoly's comprehensive finance program.
          </p>
          <button
