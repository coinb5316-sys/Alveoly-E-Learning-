// src/components/CareerNavbar.jsx - Dedicated Navbar for Career Page
              ...
              {navLinks.map((link) => (
                <a
                  ...
                  className={`text-sm font-medium transition-colors duration-300 ${
                    scrolled ? "text-gray-700 hover:text-[#00a3a1]" : "text-white/90 hover:text-white"
                  }`}
                >
                  {link.name}
                </a>
            ...
            <div className="flex flex-col h-full bg-white overflow-y-auto p-8">
              {navLinks.map((link) => (
                <a
                  ...
                  className="w-full text-left py-4 text-lg font-medium text-gray-700 hover:bg-gray-50 transition-colors border-b border-gray-100"
                >
                  {link.name}
                </a>
              ))}
